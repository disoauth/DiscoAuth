...
class AuthUrl:
  ...
  def __init__(self, client_id: str, scope: List[str], redirect_uri: str) -> None:
    
    self.baseUrl = "https://discord.com/oauth2/authorize?response_type=code&"
    ...
    self.url = self.baseUrl + self.client_id + self.redirect_uri + "&" + self.scope + "&" + self.state
